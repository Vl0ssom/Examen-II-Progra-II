<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login1.aspx.cs" Inherits="Examen_Christopher_Berrocal_Ugalde.WebForm1" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
   <title>Veterinaria Bloom</title>
    <meta charset="utf-8"/>
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Veterinaria Bloom</h2>
				</div>
			</div>
			<div class="row justify-content-center">
